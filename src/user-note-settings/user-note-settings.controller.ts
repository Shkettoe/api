...
export class UserNoteSettingsController {
  constructor(private readonly userNoteSettingsService: UserNoteSettingsService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateUserNoteSettingDto: UpdateUserNoteSettingDto) {
